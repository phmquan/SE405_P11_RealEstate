...
class MuaBanBDS extends StatefulWidget {
  const MuaBanBDS({super.key});

  @override
  State<MuaBanBDS> createState() => _MuaBanBDSState();
}

class _MuaBanBDSState extends State<MuaBanBDS> {

  final List<Map<String, String>> data = [
    {
      'imagePath': 'asset/da-nang-1.jpg',
      'loaiHinh': 'House',
      'gia': '\$500,000',
      'dientich': '200 m²',
      'vitri': 'Downtown',
